...
#define CUDNN_CONVOLUTION_FWD_SPECIFY_WORKSPACE_LIMIT          CUDNN_CONVOLUTION_FWD_ALGO_DIRECT
#define CUDNN_CONVOLUTION_BWD_FILTER_SPECIFY_WORKSPACE_LIMIT   CUDNN_CONVOLUTION_BWD_FILTER_ALGO_0
#define CUDNN_CONVOLUTION_BWD_DATA_SPECIFY_WORKSPACE_LIMIT     CUDNN_CONVOLUTION_BWD_DATA_ALGO_0
